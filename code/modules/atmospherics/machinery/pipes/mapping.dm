...
#define HELPER(Type, Color) \
	...
	HELPER_PARTIAL(/obj/effect/mapping_helpers/preload/simple_pipes/##Type,"pipe",Color)
...
#define HELPER_NAMED(Type, Name, Color) \
	...
	HELPER_PARTIAL_NAMED(/obj/effect/mapping_helpers/preload/simple_pipes/##Type,"pipe", Name, Color)
