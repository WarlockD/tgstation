...
/datum/design/nanites/metabolic_synthesis
	...
	category = list(CATEGORY_NANITES_UTILITY)
...
/datum/design/nanites/regenerative
	...
	category = list(CATEGORY_NANITES_MEDICAL)
...
/datum/design/nanites/nervous
	...
	category = list(CATEGORY_NANITES_AUGMENTATION)
...
/datum/design/nanites/glitch
	...
	category = list(CATEGORY_NANITES_DEFECTIVE)
...
/datum/design/nanites/flesh_eating
	...
	category = list(CATEGORY_NANITES_WEAPONIZED)
...
/datum/design/nanites/shock
	...
	category = list(CATEGORY_NANITES_SUPPRESSION)
...
/datum/design/nanites/sensor_health
	...
	category = list(CATEGORY_NANITES_SENSOR)
...
/datum/design/nanites/kickstart
	...
	category = list(CATEGORY_NANITES_PROTOCOLS)
