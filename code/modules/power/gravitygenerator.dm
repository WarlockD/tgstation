...
/obj/machinery/gravity_generator/part/set_broken()
	..()
	if(main_part && !(main_part.machine_stat & MACHINE_STAT_BROKEN))
...
/obj/machinery/gravity_generator/main/set_broken()
	...
	for(var/obj/machinery/gravity_generator/M in parts)
		if(!(M.machine_stat & MACHINE_STAT_BROKEN))
			M.set_broken()
	middle.cut_overlays()
	charge_count = 0
	breaker = FALSE
...
/obj/machinery/gravity_generator/main/ui_data(mob/user)
	...
	data["on"] = on
	data["operational"] = (machine_stat & MACHINE_STAT_BROKEN) ? FALSE : TRUE
...
/obj/machinery/gravity_generator/main/power_change()
	. = ..()
	investigate_log("has [machine_stat & MACHINE_STAT_NOPOWER ? "lost" : "regained"] power.", INVESTIGATE_GRAVITY)
	set_power()
...
/obj/machinery/gravity_generator/main/proc/set_power()
	var/new_state = FALSE
	if(machine_stat & (MACHINE_STAT_NOPOWER|MACHINE_STAT_BROKEN) || !breaker)
		new_state = FALSE
	else if(breaker)
		new_state = TRUE
