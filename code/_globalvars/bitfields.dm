...
DEFINE_BITFIELD(machine_stat, list(
	"MACHINE_STAT_BROKEN" = MACHINE_STAT_BROKEN,
	"MACHINE_STAT_EMPED" = MACHINE_STAT_EMPED,
	"MACHINE_STAT_MAINT"	= MACHINE_STAT_MAINT,
	"MACHINE_STAT_NOPOWER" = MACHINE_STAT_NOPOWER,
))
